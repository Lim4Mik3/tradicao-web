        ...
        <div className="grid md:grid-cols-2 gap-24 md:mt-20 p-10">
          <div className="flex  flex-col items-center justify-center gap-6 md:gap-24 md:items-start md:justify-start">
            <div className="flex flex-col gap-6">
              <h1 className="font-bold text-white text-center text-5xl md:text-start md:text-5xl">
                Uma boa gasolina, faz toda a diferença!
              </h1>
              <p className="text-white text-center md:text-start text-[16px]">
          ...
          <div className="flex  ">
            <img
              src={BannerBlog}
              alt="Banner Blog"
              className="w-[590px] h-[400px] object-cover rounded-lg"
            />
          </div>
        </div>
      </section>
